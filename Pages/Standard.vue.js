    ...
    <div class='container-fluid p-0 m-0'>
		  <div class='row p-0 m-0'>
            ...
            <div class='container-fluid p-4'>
                ...
                <h1 class=' font-bold color-secondary' v-html='page.subtitle'></h1>
            ...
            <div v-for='subpage,index in page.subpages' class='container-fluid p-0 m-0 align-content-center'>
                    ...
                    <div v-if='index%2' class='row p-0 m-0'>
                        <div class='col-9 col-md-8 col-lg-9 d-none d-sm-none d-md-block d-lg-block p-5 m-0'>
                         ...
                         <div class='col-xs-12 col-sm-12 col-md-4 col-lg-3 p-5 m-0 d-flex justify-content-center  flex-column '>
                                ...
                                <h1 class="text-center font-bold color-secondary align-self-center" v-html="subpage.title"></h1>
                                    
                        
                                <button v-if="subpage.externalURL" class='btn  btn-block btn-lg color-primary bg-secondary align-self-center' @click="gotoExternalURL(subpage.externalURL)">EXPLORE</button>
                                <router-link v-else class='btn  btn-block btn-lg color-primary bg-secondary align-self-center' :to='"/"+page.slug+"/"+subpage.slug'>EXPLORE</router-link>
                    ...
                    <div v-else class='row bg-tertiary p-0 m-0'>
                        <div class='col-xs-12 col-sm-12 col-md-4 col-lg-3 p-5 m-0 d-flex justify-content-center flex-column'>
                                ...
                                <button v-if="subpage.externalURL" class='btn  btn-block btn-lg color-primary bg-secondary align-self-center'  v-on:click="gotoExternalURL(subpage.externalURL)">EXPLORE</button>
